...
def strategy(pos):
    ...
    if mypos == 0 and pos == -1:  #做空
        openorder = api.insert_order(symbol=symbol1, direction="SELL", offset="OPEN", volume=lots,limit_price=quote1.bid_price1, advanced="FAK")
        mypos = -1
    if mypos < 0 and pos == 0:  #平空
        closeorder = api.insert_order(symbol=symbol1, direction="BUY", offset="CLOSETODAY", volume=lots,limit_price=quote1.ask_price1, advanced="FAK")  # , advanced="FAK"
        mypos = 0
